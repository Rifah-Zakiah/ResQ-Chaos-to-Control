...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['search_location'])) {
    ...
    if (!empty($search_query)) {
        // Search by location
        $sql = "SELECT * FROM Fire_Service WHERE location LIKE '%$search_query%' ORDER BY name";
...
<head>
  ...
  <meta name="description" content="ResQ Emergency Fire Service Search - Find immediate fire department help and emergency services in your location">
  <title>Emergency Fire Service Search | ResQ: Chaos To Control</title>
  ...
  <style>
    ...
    *, *::before, *::after {
    ...
    .fire-icon {
      width: 6rem;
      height: 6rem;
      background: linear-gradient(135deg, var(--color-fire), #ff5722);
      border-radius: 50%;
      display: flex;
      align-items: center;
      justify-content: center;
  ...
  <main class="emergency-search-main">
    <div class="container">
      ...
      <div class="search-hero">
        <h1 class="search-title">Emergency Fire Service Search</h1>
        <p class="search-subtitle">Find Fire Department Help</p>
        <p class="search-description">
          Search for emergency fire services and fire departments in your area. Get contact information and availability status for immediate fire emergency assistance.
        </p>
      </div>
      ...
      <div class="search-container">
        <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" class="search-form">
          ...
          <input 
            ...
            placeholder="Enter your location (e.g., 'Downtown', 'Fire Station Area', 'City Center')" 
            value="<?php echo htmlspecialchars($search_query); ?>"
            required>
          <button type="submit" class="search-button">
            <i class="fa-solid fa-search"></i> Find Fire Services
          </button>
        </form>

        <div class="emergency-info">
          <h3><i class="fa-solid fa-fire-extinguisher"></i> Fire Emergency</h3>
          <p>
            For immediate fire emergencies, call <strong>911</strong> immediately. 
            This search helps you find fire departments and fire safety services in your area.
          </p>
        </div>
      </div>
      ...
      <?php if ($search_performed): ?>
        <div class="results-container">
          <div class="results-header">
            <h2 class="results-title">Fire Services</h2>
            <p class="results-count">
              <?php echo count($search_results); ?> fire service(s) found in "<?php echo htmlspecialchars($search_query); ?>"
            </p>
          </div>

          <?php if (count($search_results) > 0): ?>
            <div class="fire-grid">
              <?php foreach ($search_results as $fire_service): ?>
                <div class="fire-card">
                  <div class="availability-badge">
                    <?php echo htmlspecialchars($fire_service['availability_hours']); ?>
                  </div>
                  ...
                  <div class="fire-header">
                    ...
                    <div class="fire-info">
                      <h3><?php echo htmlspecialchars($fire_service['name']); ?></h3>
                      <span class="fire-type">Fire Service</span>
                    </div>
                  </div>
                  ...
                  <div class="fire-details">
                    <div class="detail-row">
                      ...
                      <div class="detail-content">
                        ...
                        <div class="detail-value"><?php echo htmlspecialchars($fire_service['location']); ?></div>
                      </div>
                    </div>
                    ...
                    <div class="detail-row">
                      ...
                      <div class="detail-content">
                        ...
                        <div class="detail-value"><?php echo htmlspecialchars($fire_service['availability_hours']); ?></div>
                      </div>
                    </div>
                    ...
                    <div class="detail-row">
                      ...
                      <div class="detail-content">
                        ...
                        <div class="detail-value">#<?php echo htmlspecialchars($fire_service['id']); ?></div>
                      </div>
                    </div>
                  </div>

                  <div class="contact-highlight">
                    <div class="contact-number"><?php echo htmlspecialchars($fire_service['contact_no']); ?></div>
                    <div class="contact-label">Fire Emergency Contact</div>
                  </div>
                </div>
              <?php endforeach; ?>
            </div>
          <?php else: ?>
            <div class="no-results">
              ...
              <h3>No Fire Services Found</h3>
              <p>No fire services found in this location. Try searching with a broader area or contact emergency services directly.</p>
            </div>
          <?php endif; ?>
        </div>
      <?php endif; ?>
