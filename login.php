...
<body>
  ...
  <section class="container" style="margin:145px; text-align: center;">
    <h2 style="margin-bottom: 2rem;">Access Your Account</h2>
    <div style="display: flex; justify-content: center; gap: 4rem; flex-wrap: wrap;">
      <a href="victimlogin.php" class="btn btn-primary btn-lg">Victim</a>
      <a href="volunteerlogin.php" class="btn btn-secondary btn-lg">Volunteer</a>
    </div>
    <p style="margin-top: 3rem;">No account? <a href="register.php">Sign Up</a></p>
  </section>
