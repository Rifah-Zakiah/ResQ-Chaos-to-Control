...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['search_location'])) {
    ...
    if (!empty($search_query)) {
        // Search by location
        $sql = "SELECT * FROM Ngo_Helplines WHERE location LIKE '%$search_query%' ORDER BY name";
...
<head>
  ...
  <meta name="description" content="ResQ Emergency NGO Search - Find NGO helplines and support services in your location">
  <title>Emergency NGO Helplines | ResQ: Chaos To Control</title>
  ...
  <style>
    ...
    *, *::before, *::after {
    ...
    .search-button {
      ...
      top: 50%;
      transform: translateY(-50%);
      background-color: var(--color-ngo);
      color: var(--color-white);
      border: none;
      padding: 1.5rem 3rem;
      border-radius: 1rem;
    ...
    .ngo-card {
      ...
      box-shadow: var(--shadow-md);
      transition: var(--transition-standard);
      border-left: 5px solid var(--color-ngo);
      position: relative;
    }
    ...
    .ngo-icon {
      width: 6rem;
      height: 6rem;
      background: linear-gradient(135deg, var(--color-ngo), #8e24aa);
      border-radius: 50%;
      display: flex;
      align-items: center;
      justify-content: center;
    ...
    .availability-badge {
      ...
      font-size: 1.2rem;
      font-weight: 600;
      border: 2px solid var(--color-ngo);
    }
  ...
  <main class="emergency-search-main">
    <div class="container">
      ...
      <div class="search-hero">
        <h1 class="search-title">NGO Helplines Search</h1>
        <p class="search-subtitle">Find NGO Support Services</p>
        <p class="search-description">
          Search for NGO helplines and support organizations in your area. Get contact information and availability for immediate assistance from trusted non-profit organizations.
        </p>
      </div>
      ...
      <div class="search-container">
        <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" class="search-form">
          ...
          <input 
            ...
            placeholder="Enter your location (e.g., 'Downtown', 'NGO Center', 'City Center')" 
            value="<?php echo htmlspecialchars($search_query); ?>"
            required>
          <button type="submit" class="search-button">
            <i class="fa-solid fa-search"></i> Find NGO Help
          </button>
        </form>

        <div class="emergency-info">
          <h3><i class="fa-solid fa-hands-helping"></i> NGO Support Services</h3>
          <p>
            For immediate life-threatening emergencies, call <strong>911</strong> first. 
            NGO helplines provide vital support services, counseling, and long-term assistance for various emergency situations.
          </p>
        </div>
      </div>
      ...
      <?php if ($search_performed): ?>
        <div class="results-container">
          <div class="results-header">
            <h2 class="results-title">NGO Helplines</h2>
            <p class="results-count">
              <?php echo count($search_results); ?> NGO helpline(s) found in "<?php echo htmlspecialchars($search_query); ?>"
            </p>
          </div>

          <?php if (count($search_results) > 0): ?>
            <div class="ngo-grid">
              <?php foreach ($search_results as $ngo): ?>
                <div class="ngo-card">
                  <div class="availability-badge">
                    <?php echo htmlspecialchars($ngo['availability_hours']); ?>
                  </div>
                  ...
                  <div class="ngo-header">
                    ...
                    <div class="ngo-info">
                      <h3><?php echo htmlspecialchars($ngo['name']); ?></h3>
                      <span class="ngo-type">NGO Helpline</span>
                    </div>
                  </div>
                  ...
                  <div class="ngo-details">
                    <div class="detail-row">
                      ...
                      <div class="detail-content">
                        ...
                        <div class="detail-value"><?php echo htmlspecialchars($ngo['location']); ?></div>
                      </div>
                    </div>
                    ...
                    <div class="detail-row">
                      ...
                      <div class="detail-content">
                        ...
                        <div class="detail-value"><?php echo htmlspecialchars($ngo['availability_hours']); ?></div>
                      </div>
                    </div>
                    ...
                    <div class="detail-row">
                      ...
                      <div class="detail-content">
                        ...
                        <div class="detail-value">#<?php echo htmlspecialchars($ngo['id']); ?></div>
                      </div>
                    </div>
                  </div>

                  <div class="contact-highlight">
                    <div class="contact-number"><?php echo htmlspecialchars($ngo['contact_no']); ?></div>
                    <div class="contact-label">NGO Helpline Number</div>
                  </div>
                </div>
              <?php endforeach; ?>
            </div>
          <?php else: ?>
            <div class="no-results">
              ...
              <h3>No NGO Helplines Found</h3>
              <p>No NGO helplines found in this location. Try searching with a broader area or contact national NGO networks directly.</p>
            </div>
          <?php endif; ?>
        </div>
      <?php endif; ?>
      ...
      <div class="footer-grid">
        ...
        <div class="footer-links">
          ...
          <ul>
            ...
            <li><a href="what-to-do">Disaster Updates</a></li>
