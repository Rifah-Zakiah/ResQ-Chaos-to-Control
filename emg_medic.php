...
<head>
  ...
  <meta name="description" content="ResQ Emergency Medical Search - Find immediate medical help and emergency services in your location">
  <title>Emergency Medical Search | ResQ: Chaos To Control</title>
  ...
  <style>
    ...
    *, *::before, *::after {
    ...
    .medical-icon {
      width: 6rem;
      height: 6rem;
      background: linear-gradient(135deg, var(--color-medical), #4caf50);
      border-radius: 50%;
      display: flex;
      align-items: center;
      justify-content: center;
  ...
  <main class="emergency-search-main">
    <div class="container">
      ...
      <div class="search-hero">
        <h1 class="search-title">Emergency Medical Search</h1>
        <p class="search-subtitle">Find Immediate Medical Help</p>
        <p class="search-description">
          Search for emergency medical response teams and healthcare services in your area. Get contact information and availability status for immediate medical assistance.
        </p>
      </div>
      ...
      <div class="search-container">
        <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" class="search-form">
          ...
          <input 
            ...
            placeholder="Enter your location (e.g., 'Downtown', 'Hospital Area', 'City Center')" 
            value="<?php echo htmlspecialchars($search_query); ?>"
            required>
          <button type="submit" class="search-button">
            <i class="fa-solid fa-search"></i> Find Medical Help
          </button>
        </form>
        ...
        <div class="emergency-info">
          ...
          <p>
            ...
            This search helps you find medical response teams for urgent but non-critical situations.
          </p>
        </div>
      </div>
      ...
      <?php if ($search_performed): ?>
        <div class="results-container">
          <div class="results-header">
            <h2 class="results-title">Medical Response Teams</h2>
            <p class="results-count">
              <?php echo count($search_results); ?> medical response team(s) found in "<?php echo htmlspecialchars($search_query); ?>"
            </p>
          </div>

          <?php if (count($search_results) > 0): ?>
            <div class="medical-grid">
              <?php foreach ($search_results as $medical): ?>
                <div class="medical-card">
                  <div class="availability-badge">
                    <?php echo htmlspecialchars($medical['availability_hours']); ?>
                  </div>
                  ...
                  <div class="medical-header">
                    ...
                    <div class="medical-info">
                      <h3><?php echo htmlspecialchars($medical['name']); ?></h3>
                      <span class="medical-type">Medical Response</span>
                    </div>
                  </div>
                  ...
                  <div class="contact-highlight">
                    ...
                    <div class="contact-label">Emergency Contact Number</div>
                  </div>
                </div>
              <?php endforeach; ?>
            </div>
          <?php else: ?>
            <div class="no-results">
              ...
              <h3>No Medical Teams Found</h3>
              <p>No medical response teams found in this location. Try searching with a broader area or contact emergency services directly.</p>
            </div>
          <?php endif; ?>
        </div>
      <?php endif; ?>
