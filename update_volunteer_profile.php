...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $assigned_location = mysqli_real_escape_string($conn, trim($_POST['assigned_location']));
    ...
    if (empty($errors)) {
        ...
        if (!empty($new_password)) {
            ...
            $sql = "UPDATE Volunteer SET name=?, address=?, phone_no=?, email=?, occupation=?, dob=?, assigned_location=?, medical_info=?, blood_group=?, allergy=?, chronic_disease=?, password=? WHERE id=?";
            $stmt = $conn->prepare($sql);
            $stmt->bind_param("ssssssssssssi", $name, $address, $phone_no, $email, $occupation, $dob, $assigned_location, $medical_info, $blood_group, $allergy, $chronic_disease, $hashed_password, $volunteer_id);
        } else {
            // Update without changing password
            $sql = "UPDATE Volunteer SET name=?, address=?, phone_no=?, email=?, occupation=?, dob=?, assigned_location=?, medical_info=?, blood_group=?, allergy=?, chronic_disease=? WHERE id=?";
            $stmt = $conn->prepare($sql);
            $stmt->bind_param("sssssssssssi", $name, $address, $phone_no, $email, $occupation, $dob, $assigned_location, $medical_info, $blood_group, $allergy, $chronic_disease, $volunteer_id);
        }
...
<head>
    ...
    <meta name="description" content="ResQ Volunteer Profile Update - Edit your volunteer information">
    <title>Update Volunteer Profile | ResQ: Chaos To Control</title>
    ...
    <style>
        ...
        *, *::before, *::after {
        ...
        .form-icon {
            width: 6rem;
            height: 6rem;
            background: linear-gradient(135deg, var(--color-volunteer), #9c27b0);
            border-radius: 50%;
            display: flex;
            align-items: center;
            justify-content: center;
        ...
        .form-input:focus {
            outline: none;
            border-color: var(--color-volunteer);
        ...
        .password-section {
            ...
            margin-bottom: 3rem;
            border-left: 4px solid var(--color-volunteer);
        }
            ...
            <div class="navbar">
                ...
                <nav class="nav-desktop">
                    <ul>
                        ...
                        <li><a href="volunteer_profile.php"><i class="fa-solid fa-user"></i> Profile</a></li>
                        <li><a href="needhelp.php"><i class="fa-solid fa-circle-exclamation"></i> Emergency</a></li>
                    </ul>
                    <div class="nav-actions">
                        <span class="btn btn-volunteer"><i class="fa-solid fa-user-check"></i> <?php echo htmlspecialchars($volunteer['name']); ?></span>
    ...
    <main class="main-content">
        <div class="container">
            ...
            <div class="profile-header">
                <h1 class="profile-title">Update Volunteer Profile</h1>
                <p class="profile-subtitle">Edit Your Information</p>
                <p class="profile-description">
                    Update your personal information, contact details, and volunteer preferences. 
                    Keep your profile current to help us match you with appropriate volunteer opportunities.
                </p>
            </div>
            ...
            <div class="profile-container">
                <div class="form-header">
                    ...
                    <div>
                        ...
                        <p class="form-subtitle">Update your volunteer details and preferences</p>
                    </div>
                </div>
                ...
                <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input type="text" id="name" name="name" class="form-input" 
                                   value="<?php echo htmlspecialchars($volunteer['name']); ?>" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" id="email" name="email" class="form-input" 
                                   value="<?php echo htmlspecialchars($volunteer['email']); ?>" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="tel" id="phone_no" name="phone_no" class="form-input" 
                                   value="<?php echo htmlspecialchars($volunteer['phone_no']); ?>" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" id="dob" name="dob" class="form-input" 
                                   value="<?php echo htmlspecialchars($volunteer['dob']); ?>">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="occupation" name="occupation" class="form-input" 
                                   value="<?php echo htmlspecialchars($volunteer['occupation']); ?>">
                        </div>
                        ...
                        <div class="form-group full-width">
                            ...
                            <textarea id="address" name="address" class="form-input form-textarea" 
                                      placeholder="Enter your full address"><?php echo htmlspecialchars($volunteer['address']); ?></textarea>
                        </div>

                        <div class="form-group full-width">
                            <label for="assigned_location" class="form-label">
                                <i class="fa-solid fa-map-marker-alt"></i> Assigned Location
                            </label>
                            <input type="text" id="assigned_location" name="assigned_location" class="form-input" 
                                   value="<?php echo htmlspecialchars($volunteer['assigned_location']); ?>"
                                   placeholder="Area or location where you prefer to volunteer">
                        </div>
                    </div>
                    ...
                    <div class="form-grid">
                        <div class="form-group full-width">
                            ...
                            <textarea id="medical_info" name="medical_info" class="form-input form-textarea" 
                                      placeholder="Any relevant medical information, certifications, or training"><?php echo htmlspecialchars($volunteer['medical_info']); ?></textarea>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="allergy" name="allergy" class="form-input" 
                                   value="<?php echo htmlspecialchars($volunteer['allergy']); ?>"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="chronic_disease" name="chronic_disease" class="form-input" 
                                   value="<?php echo htmlspecialchars($volunteer['chronic_disease']); ?>"
                    ...
                    <div class="form-actions">
                        <a href="volunteer_profile.php" class="btn-secondary">
