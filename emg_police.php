...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['search_location'])) {
    ...
    if (!empty($search_query)) {
        // Search by location
        $sql = "SELECT * FROM Police WHERE location LIKE '%$search_query%' ORDER BY name";
...
<head>
  ...
  <meta name="description" content="ResQ Emergency Police Search - Find immediate police help and law enforcement services in your location">
  <title>Emergency Police Search | ResQ: Chaos To Control</title>
  ...
  <style>
    ...
    *, *::before, *::after {
    ...
    .police-card {
      ...
      box-shadow: var(--shadow-md);
      transition: var(--transition-standard);
      border-left: 5px solid var(--color-police);
      position: relative;
    }
    ...
    .police-icon {
      width: 6rem;
      height: 6rem;
      background: linear-gradient(135deg, var(--color-police), #1976d2);
      border-radius: 50%;
      display: flex;
      align-items: center;
      justify-content: center;
    ...
    .availability-badge {
      ...
      font-size: 1.2rem;
      font-weight: 600;
      border: 2px solid var(--color-police);
    }
  ...
  <main class="emergency-search-main">
    <div class="container">
      ...
      <div class="search-hero">
        <h1 class="search-title">Emergency Police Search</h1>
        <p class="search-subtitle">Find Law Enforcement Help</p>
        <p class="search-description">
          Search for police stations and law enforcement services in your area. Get contact information and availability status for immediate police assistance and security services.
        </p>
      </div>
      ...
      <div class="search-container">
        <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" class="search-form">
          ...
          <input 
            ...
            placeholder="Enter your location (e.g., 'Downtown', 'Police Station Area', 'City Center')" 
            value="<?php echo htmlspecialchars($search_query); ?>"
            required>
          <button type="submit" class="search-button">
            <i class="fa-solid fa-search"></i> Find Police Services
          </button>
        </form>

        <div class="emergency-info">
          <h3><i class="fa-solid fa-shield-alt"></i> Police Emergency</h3>
          <p>
            For immediate emergencies requiring police response, call <strong>911</strong> immediately. 
            This search helps you find local police stations and law enforcement services in your area.
          </p>
        </div>
      </div>
      ...
      <?php if ($search_performed): ?>
        <div class="results-container">
          <div class="results-header">
            <h2 class="results-title">Police Services</h2>
            <p class="results-count">
              <?php echo count($search_results); ?> police service(s) found in "<?php echo htmlspecialchars($search_query); ?>"
            </p>
          </div>

          <?php if (count($search_results) > 0): ?>
            <div class="police-grid">
              <?php foreach ($search_results as $police_service): ?>
                <div class="police-card">
                  <div class="availability-badge">
                    <?php echo htmlspecialchars($police_service['availability_hours']); ?>
                  </div>
                  ...
                  <div class="police-header">
                    ...
                    <div class="police-info">
                      <h3><?php echo htmlspecialchars($police_service['name']); ?></h3>
                      <span class="police-type">Police Service</span>
                    </div>
                  </div>
                  ...
                  <div class="police-details">
                    <div class="detail-row">
                      ...
                      <div class="detail-content">
                        ...
                        <div class="detail-value"><?php echo htmlspecialchars($police_service['location']); ?></div>
                      </div>
                    </div>
                    ...
                    <div class="detail-row">
                      ...
                      <div class="detail-content">
                        ...
                        <div class="detail-value"><?php echo htmlspecialchars($police_service['availability_hours']); ?></div>
                      </div>
                    </div>
                    ...
                    <div class="detail-row">
                      ...
                      <div class="detail-content">
                        ...
                        <div class="detail-value">#<?php echo htmlspecialchars($police_service['id']); ?></div>
                      </div>
                    </div>
                  </div>

                  <div class="contact-highlight">
                    <div class="contact-number"><?php echo htmlspecialchars($police_service['contact_no']); ?></div>
                    <div class="contact-label">Police Contact Number</div>
                  </div>
                </div>
              <?php endforeach; ?>
            </div>
          <?php else: ?>
            <div class="no-results">
              ...
              <p>No police services found in this location. Try searching with a broader area or contact emergency services directly.</p>
            </div>
          <?php endif; ?>
        </div>
      <?php endif; ?>
